        ...
        setTimeout(function() {
            ...
            if (USE_XHR) {
                ...
                test("tracking should escape the body data of POST request", 5, function() {
                    // this body is known to generate a the characters + and = when using encode_data_for_request
                    ...
                    for (var i = 0; i < badCharacters.length; i += 1) {
                        var barCharacter = badCharacters[i];
                        same(
                            bodyData.indexOf(barCharacter), -1,
                            'POST request body has invalid character ' + barCharacter
                        );
                    }
                });
